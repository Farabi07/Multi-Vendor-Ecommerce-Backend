...
urlpatterns = [
    ...
    #url shortner
    path('redirect/', include('url_shortener.urls.shortner_urls')),
    ...
    path('ecom_product/', include('ecom.urls.product_urls')),
    path('ecom_customer/', include('ecom.urls.customer_urls')),
    path('ecom_order/', include('ecom.urls.order_urls')),
    path('ecom_orderItem/', include('ecom.urls.orderItem_urls')),
